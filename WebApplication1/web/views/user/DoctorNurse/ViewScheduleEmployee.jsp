    ...
    <div class="container">
        ...
        <c:if test="${empty schedules}">
            <div class="no-schedules-message">
                ...
                <p>Vui lòng chọn tuần khác hoặc thêm lịch làm việc mới.</p>
            </div>
        </c:if>

        <a href="${pageContext.request.contextPath}/views/user/DoctorNurse/EmployeeDashBoard.jsp" class="back-link">← Quay lại Dashboard</a>
    </div>
