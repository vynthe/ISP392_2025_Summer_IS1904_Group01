...
<body class="bg-gray-100 font-sans">
    <div class="container max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-md mt-5">
        <h1 class="text-2xl font-bold text-center text-gray-800 mb-6">Lịch Làm Việc (Bác Sĩ/Y Tá)</h1>
        ...
        <a href="${pageContext.request.contextPath}/views/DoctorNurse/EmployeeDashBoard.jsp" class="block mt-5 text-center text-blue-600 font-semibold hover:underline">Quay lại Dashboard</a>
    </div>
