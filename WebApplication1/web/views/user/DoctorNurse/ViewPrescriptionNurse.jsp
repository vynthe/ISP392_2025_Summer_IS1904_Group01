    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" href="${pageContext.request.contextPath}/ViewPrescriptionNurse" class="nav-item active">
                    Xem đơn thuốc
                </a>
            </div>
        </div>
                ...
                <div>
                    <h1 class="page-title">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>Đơn Thuốc Được Gán</c:otherwise>
                        </c:choose>
                    </h1>
                    <p class="page-subtitle">
                        <c:choose>
                            <c:when test="${isDetailView}">Thông tin chi tiết về đơn thuốc được giao</c:when>
                            <c:otherwise>Quản lý và theo dõi các đơn thuốc được giao cho bạn</c:otherwise>
                        </c:choose>
                    </p>
                </div>
            ...
            <div class="detail-card fade-in">
                ...
                <div class="detail-body">
                        ...
                        <div class="col-md-6">
                            <div class="info-card border-left-primary">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="patient-name">${prescriptionDetail.patientName}</span>
                                </div>
                                <div class="info-item">
                                    <i class="fas fa-user-md info-icon"></i>
                                    <span>Bác sĩ: ${prescriptionDetail.doctorName}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="text-center">
                        <a href="${pageContext.request.contextPath}/ViewPrescriptionNurse" 
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="stat-card stat-primary">
                            ...
                            <div class="stat-title">Tổng số đơn thuốc được gán</div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="prescription-card fade-in" style="animation-delay: ${status.index * 0.1}s">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="patient-info border-left-primary">
                                            ...
                                            <div class="info-item">
                                                <i class="fas fa-user-md info-icon"></i>
                                                <span>Bác sĩ: ${prescription.doctorName}</span>
                                            </div>
                                            <div class="info-item">
                                                <i class="fas fa-calendar-day info-icon"></i>
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="${pageContext.request.contextPath}/ViewPrescriptionNurse?action=detail&prescriptionId=${prescription.prescriptionId}" 
