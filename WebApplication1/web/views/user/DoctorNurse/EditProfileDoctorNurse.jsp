...
<body>
    ...
    <header class="header">
        <div class="header-content">
            ...
            <nav>
                <ul class="nav-menu">
                    <li><a href="${pageContext.request.contextPath}/views/user/DoctorNurse/EmployeeDashBoard.jsp">Trang Chủ</a></li>
    ...
    <main class="main-content">
        <div class="container">
            <div class="header-section">
                ...
                <h1>Chỉnh sửa hồ sơ bác sĩ/y tá</h1>
                <p>Cập nhật thông tin chuyên môn và cá nhân của bạn</p>
            </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="specialization">
                                Trình độ chuyên môn <span class="required">*</span>
                            </label>
                            <select id="specialization" name="specialization" class="form-select" required>
                                ...
                                <option value="Y Tá" ${sessionScope.user.specialization == 'Y Tá' ? 'selected' : ''}>Y tá</option>
                                <option value="Điều Dưỡng" ${sessionScope.user.specialization == 'Điều Dưỡng' ? 'selected' : ''}>Điều dưỡng viên</option>
                            </select>
                        </div>
                    </div>
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-section">
                <h4>Hệ Thống Quản Lý Y Tế</h4>
                <p>Nền tảng quản lý thông tin chuyên nghiệp cho đội ngũ y bác sĩ.</p>
            </div>
            ...
            <div class="footer-section">
                ...
                <ul>
                    <li><a href="${pageContext.request.contextPath}/views/user/DoctorNurse/EmployeeDashBoard.jsp">Trang Chủ</a></li>
                    <li><a href="${pageContext.request.contextPath}/DoctorNurseProfileController">Hồ Sơ</a></li>
                    <li><a href="${pageContext.request.contextPath}/EditProfileUserController">Chỉnh Sửa Hồ Sơ</a></li>
                </ul>
            </div>
            
            <div class="footer-section">
                <h4>Liên Hệ</h4>
                <p>PhongKhamPDC@gmail.com</p>
                <p>0987 123 456</p>
            </div>
        </div>
        
        <div class="footer-bottom">
            <p>© 2025 Hệ Thống Quản Lý Y Tế. Tất cả quyền được bảo lưu.</p>
        </div>
    </footer>
