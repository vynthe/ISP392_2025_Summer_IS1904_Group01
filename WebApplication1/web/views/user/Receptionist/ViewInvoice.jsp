        ...
        <div class="container">
            <div class="header">
                <div class="header-nav">
                    <a href="${pageContext.request.contextPath}/views/user/Receptionist/ReceptionistDashBoard.jsp" class="nav-btn home-btn">
                        <i class="fas fa-home"></i>
                        Trang chủ
                    </a>
                    <a href="${pageContext.request.contextPath}/ViewInvoiceServlet" class="nav-btn">
                ...
                <c:choose>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fas fa-clipboard-check"></i>Kết Quả Khám</th>
                                        <!-- BỔ SUNG Ở ĐÂY: Thêm 2 cột mới vào bảng -->
                                ...
                                <tbody>
                                    <c:forEach items="${results}" var="result" varStatus="loop">
                                        <tr>
                                            <td class="stt-cell">${(currentPage - 1) * pageSize + loop.count}</td>
                                            ...
                                            <td class="result-cell" title="${result.resultName}">${result.resultName}</td>
                                            <!-- BỔ SUNG Ở ĐÂY: Hiển thị tổng tiền và trạng thái cho từng hóa đơn -->
                                            <td>${result.totalAmount}</td>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${result.status == 'Chưa thanh toán'}">
                                                        <span style="color: #e67e22; font-weight: bold;">Chưa thanh toán</span>
                                                    </c:when>
                                                    <c:when test="${result.status == 'Đã thanh toán'}">
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <form method="get" action="${pageContext.request.contextPath}/UpdateInvoiceServlet" style="display:inline;">
                    ...
                    <c:otherwise>
                        <div class="no-data">
                            ...
                            <p>Không có hóa đơn nào phù hợp với tiêu chí tìm kiếm của bạn.<br>
