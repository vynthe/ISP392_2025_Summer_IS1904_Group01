...
<head>
    ...
    <style>
        ...
        .info-value { color: #222; margin-left: 8px; }
        .amount { color: #27ae60; font-size: 1.3em; font-weight: bold; }
        .btn-confirm {
        ...
        .btn-confirm:hover { background: linear-gradient(90deg, #6ed0fa, #4f8cff); }
    </style>
</head>
<body>
<div class="confirm-container">
    ...
    <div class="info-row"><span class="info-label">Dịch vụ:</span><span class="info-value">${serviceName}</span></div>
    <div class="info-row"><span class="info-label">Số tiền:</span><span class="info-value amount">${servicePrice} VNĐ</span></div>
    <form method="post" action="${pageContext.request.contextPath}/ViewInvoiceServlet">
