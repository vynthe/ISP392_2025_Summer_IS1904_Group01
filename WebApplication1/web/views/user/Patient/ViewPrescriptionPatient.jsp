        ...
        <style>
            ...
            * {
            ...
            @media print {
                ...
                .prescription-card, .detail-card, .info-card, .prescription-details, .diagnosis-section, .doctor-info, .patient-info, .doctor-section, .nurse-section, .date-section, .signature-section {
                ...
                .prescription-id, .doctor-name, .diagnosis-title, .patient-name {
                    color: #000;
                    font-size: 9pt;
                }
                ...
                <div class="detail-card fade-in">
                    ...
                    <div class="detail-body">
                        ...
                        <div class="nurse-section">
                            <h5>
                                <i class="fas fa-user-nurse me-2"></i>Họ Và Tên Y Tá
                            </h5>
                            <div class="info-item">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <div class="timestamp">
                                                        ...
                                                        <strong>Ngày Kê Đơn:</strong> ${prescription.createdAt != null ? prescription.createdAt.toString().substring(0, 16).replace('T', ' ') : 'Không có'}
                                                    </div>
                                                    <div class="timestamp">
                                                        <i class="fas fa-clock me-2"></i>
                                                        <strong>Ngày Cập nhật:</strong> ${prescription.updatedAt != null ? prescription.updatedAt.toString().substring(0, 16).replace('T', ' ') : 'Không có'}
                                                    </div>
                                                </div>
