    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="${pageContext.request.contextPath}/ViewPrescriptionPatient">
                    <i class="fas fa-prescription-bottle-alt me-2"></i>Xem đơn thuốc
                </a>
            </div>
        </div>
    </nav>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="notes-section border-left-success">
                                                ...
                                                <p class="notes-preview">
                                                    ${prescription.notes != null ? prescription.notes : 'Không có ghi chú'}
                                                </p>
                                            </div>
                                        </div>
