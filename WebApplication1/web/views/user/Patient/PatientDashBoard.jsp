...
<html lang="vi">
    ...
    <body>
        ...
        <header>
            <div class="container">
                <div class="header-content">
                    <div class="logo"><i class="fas fa-tooth"></i><div><h1>PDC</h1><span>Nha Khoa PDC</span></div></div>
                    <nav>
                        <a href="${pageContext.request.contextPath}/views/common/HomePage.jsp"><i class="fas fa-home"></i> Trang chủ</a>
        ...
        <div class="chatbot-toggle" id="chatbotToggle"><i class="fas fa-comment"></i></div>
        ...
        <script>
            ...
            // Chatbot send message function - Aligned with homepage ChatbotServlet
            ...
            // Fallback responses aligned with homepage
