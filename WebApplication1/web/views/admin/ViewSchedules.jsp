<%-- 
    ...
    Created on : 5 Jun 2025, 17:45:30
    Author     : exorc
--%>
    ...
    <div class="container-wrapper">
        <div class="container">
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <a href="${pageContext.request.contextPath}/views/admin/AddSchedule.jsp" class="btn btn-success">Thêm Lịch Trình</a>
            </div>
            <h2 class="text-center mb-4">Danh Sách Lịch Trình</h2>
