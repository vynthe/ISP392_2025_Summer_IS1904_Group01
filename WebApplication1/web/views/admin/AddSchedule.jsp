    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="text-center mb-4">
                ...
                <p class="lead text-muted">Tự động tạo lịch làm việc cho nhân viên y tế</p>
            </div>
            ...
            <div id="autoForm" class="schedule-card card p-4 mb-4">
                <div class="card-body">
                    ...
                    <form id="autoScheduleForm" method="post" action="${pageContext.request.contextPath}/AddScheduleServlet">
                        ...
                        <p class="text-muted mb-3">Thêm lịch trình riêng cho nhân viên cụ thể, ghi đè lịch chung.</p>

                        <div id="specialSchedulesContainer"></div>
            ...
            div.innerHTML = `
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="invalid-feedback">Vui lòng chọn giờ kết thúc (phải lớn hơn giờ bắt đầu).</div>
                    </div>
                </div>
                <div class="mb-3">
        ...
        document.getElementById('autoScheduleForm').addEventListener('submit', function (e) {
            ...
            document.querySelectorAll('.special-schedule-item').forEach(item => {
                ...
                checkboxes.forEach(cb => {
                    if (cb.checked) daySelected = true;
                });
                if (!daySelected) {
                    isValid = false;
