...
<head>
    ...
    <title>Thêm Dịch Vụ | Admin Dashboard</title>
                ...
                <nav>
                    <ul class="main-nav">
                        ...
                        <li><a href="${pageContext.request.contextPath}/AddServiceServlet" class="active">
                            <i class="fas fa-plus"></i> Thêm Dịch Vụ</a></li>
                    </ul>
                </nav>
            </div>
        </div>
                    ...
                    <form action="${pageContext.request.contextPath}/AddServiceServlet" method="post" id="serviceForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="serviceName" name="serviceName" 
                                   value="${sessionScope.formData.serviceName}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" 
                                      placeholder="Nhập mô tả dịch vụ" rows="4">${sessionScope.formData.description}</textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price" 
                                   value="${sessionScope.formData.price}" 
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="status" name="status" required>
                                ...
                                <option value="Inactive" ${sessionScope.formData.status == 'Inactive' ? 'selected' : ''}>Tạm dừng</option>
                            </select>
                        </div>
