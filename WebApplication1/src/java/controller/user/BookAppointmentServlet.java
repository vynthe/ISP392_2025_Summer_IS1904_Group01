    ...
    private void handleInitialLoad(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (doctorIdParam != null && !doctorIdParam.trim().isEmpty()) {
                ...
                // ✅ Load doctor details using the viewDetailBook method we saw earlier
                ...
                LOGGER.info("Loaded doctor details for doctorId: " + doctorId);
            }
            ...
            setErrorAndForward(request, response, "Không thể tải thông tin bác sĩ.");
        }
    }
